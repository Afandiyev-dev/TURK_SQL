...
SELECT Id, Name, Surname, Estimate, BAL, KSQ1, KSQ2, KSQ3, KSQ4, BKSQ FROM School WHERE (Id = @Id)";
        ...
        public virtual int Fill(TestDataSet.SchoolDataTable dataTable) {
        ...
        public virtual TestDataSet.SchoolDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TestDataSet.SchoolDataTable dataTable = new TestDataSet.SchoolDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TestDataSet.SchoolDataTable dataTable) {
