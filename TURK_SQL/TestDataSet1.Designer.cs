...
namespace TURK_SQL.TestDataSet1TableAdapters {
...
SELECT ID, Name, Surname, Estimate, BAL, KSQ1, KSQ2, KSQ3, KSQ4, BKSQ FROM School WHERE (ID = @ID)";
        ...
        public virtual int Fill(TestDataSet1.SchoolDataTable dataTable) {
        ...
        public virtual TestDataSet1.SchoolDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TestDataSet1.SchoolDataTable dataTable = new TestDataSet1.SchoolDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TestDataSet1.SchoolDataTable dataTable) {
